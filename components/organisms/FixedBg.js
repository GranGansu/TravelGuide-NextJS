...
const FixedBg = forwardRef(function FixedBg(props, ref) {
  ...
  return (
    <div className='overflow-hidden w-full sm:h-screen h-[50vh] relative bg-gray-700/80 flex items-center justify-center'>
      <motion.div
      ...
      <div className='z-40 relative items-center flex space-y-4 flex-col'>
        ...
        <button className='p-4 border-2 rounded-full bg-white text-slate-900 shadow-md relative overflow-hidden flex items-center gap-x-2'>
          ...
          <svg className='w-12' clip-rule='evenodd' fill-rule='evenodd' stroke-linejoin='round' stroke-miterlimit='2' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
            <path
          ...
          <span className='relative z-10 font-bold text-xl'>Tickets</span>
        </button>
      </div>
    </div>
  );
