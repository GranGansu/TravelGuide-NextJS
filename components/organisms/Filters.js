  ...
  return (
    <ul className='flex gap-x-2 sm:justify-center overflow-x-scroll px-6'>
      <AnimatePresence>
        ...
        <button onClick={handleReset} className='hover:cursor-pointer min-w-fit p-1 px-2 bg-green-700 border-green-500 border-2 rounded-full fill-white flex gap-x-1 items-center'>
